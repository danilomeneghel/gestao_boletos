...
$banco = mysqli_query($conexao,"SELECT * FROM bancos WHERE id_banco='3'")or die (mysqli_error($conexao));
...
$compra = mysqli_query($conexao,"SELECT *,date_format(data_venci, '%d/%m/%Y') AS datad, date_format(data, '%d/%m/%Y') AS data FROM faturas WHERE id_venda='$id_venda' AND situacao !='B'")or die (mysqli_error($conexao));
...
$cli = mysqli_query($conexao,"SELECT * FROM cliente WHERE id_cliente='$idcliente'")or die (mysqli_error($conexao));
...
$up = mysqli_query($conexao,"UPDATE faturas SET nosso_numero ='$numero', banco ='$banco' WHERE id_venda='$id_venda'") or die(mysqli_error($conexao));
?>
