      ...
      <tr>
        <td width="191" valign="top" style="border:0;">
          ...
          <tr>
            ...
            <td width="37" align="center"><span class="claro">Recibo Pagador</span></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="3" valign="top" class="bordaRight bordaLeft"><span class="ct">Agência/Código Beneficiário</span><br/>
                  <span class="campo">
...
Outros acréscimos</span></td>
      ...
      Valor cobrado</span></td>
          ...
          <tr>
            <td colspan="3" valign="top" class="bordaRight bordaLeft">Pagador<br/> <?php echo $dadosboleto["sacado"]?><br/>
  ...
  <tr>
    <td colspan="5" valign="top" class="bordaRight bordaLeft">
    <span class="ct">Beneficiário</span><br/>
      	<span class="campo" style="float:none;">
 		 <?php echo $dadosboleto["cedente"]?>
  		</span>
    </td>
    <td valign="top">
      <span class="ct">Agência/Código Beneficiário</span><br/>
      <span class="campo">
        <?php echo $dadosboleto["agencia_codigo"]?>
        </span>
    </td>
 ...
 <?php echo $dadosboleto["quantidade"]?>
  ...
  <tr>
    <td colspan="5" rowspan="5" align="left" class="bordaRight bordaLeft">
        <span class="cp"><strong>Instruções (Texto de responsabilidade do Beneficiário)</strong></span>
    ...
    <TABLE cellSpacing=0 cellPadding=0 border=0 width=666>
      <TBODY>
        <TR>
          ...
          <TD class=ct2  width=409 style="border:none;">Pagador/Avalista</TD>
