...
if(isset($_POST['update'])){
	...
	$up = mysqli_query($conexao,"UPDATE flux_fixas SET descricao_fixa = '$descricao_fixa', dia_vencimento = '$dia_vencimento', valor_fixa = '$valor_fixa'
...
$sql = mysqli_query($conexao,"SELECT * FROM flux_fixas WHERE id_fixa = $id_fixa");
