...
if(isset($_POST['alterar'])){
	...
	$a = mysqli_query($conexao,"UPDATE flux_planos SET descricao='$descricao' WHERE id_plano= '$id'") or die(mysqli_error());	
	if($a == 1){
	print "<script type=\"text/javascript\">javascript:window.close()</script>";		
	}
}

$sql = mysqli_query($conexao,"SELECT * FROM flux_planos WHERE id_plano='$id'");
