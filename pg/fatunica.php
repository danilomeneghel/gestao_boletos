  ...
  <div id="forms">
    <form action="" method="post" name="formu" id="formu" enctype="multipart/formu-data" onSubmit="return validar_uni(this);">
      ...
      <select name="id_cliente">
        ...
        <?php
        $sql = mysqli_query($conexao,"SELECT * FROM cliente WHERE bloqueado ='N' ORDER BY nome ASC")or die (mysqli_error());
         while($linha = mysqli_fetch_array($sql)){
        ?>
          <option value="<?php echo $linha['id_cliente'] ?>"><?php echo $linha['nome']; ?></option>
        <?php } ?>
      </select>
      <br/>
