...
//------------------------------------------------------------------------
$sql = mysqli_query($conexao,"SELECT * FROM config")or die (mysql_error());
$linha = mysqli_fetch_array($sql);

$logo = $linha['logo'];

$banco = mysqli_query($conexao,"SELECT * FROM bancos WHERE id_banco='1'")or die (mysql_error());
...
$compra = mysqli_query($conexao,"SELECT *,date_format(data_venci, '%d/%m/%Y') AS datad, date_format(data, '%d/%m/%Y') AS data FROM faturas WHERE id_venda='$id_venda' AND situacao !='B'")or die (mysql_error());
$valor = mysqli_fetch_array($compra);
...
$cli = mysqli_query($conexao,"SELECT * FROM cliente WHERE id_cliente='$idcliente'")or die (mysql_error());
...
$dadosboleto["especie_doc"] = $li['especie'];
...
$dadosboleto["cedente"] = $linha['nome'].' - '.$linha['cpf'];
...
$banco = "BRADESCO";
$up = mysqli_query($conexao,"UPDATE faturas SET nosso_numero ='$numero', WHERE id_venda='$id_venda'") or die(mysql_error());
?>
